...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Harmonian version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  harmoniand [options]                     " + "\n" +
                  "  harmoniand [options] <command> [params]  " + _("Send command to -server or harmoniand") + "\n" +
                  "  harmoniand [options] help                " + _("List commands") + "\n" +
                  "  harmoniand [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "harmonian:") && !boost::algorithm::istarts_with(argv[i], "ppcoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: harmonian.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: harmoniand.pid)") + "\n" +
...
{
    RenameThread("harmonian-loadblk");
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (fDaemon)
        fprintf(stdout, "Harmonian server starting\n");
