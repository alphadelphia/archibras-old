...
static unsigned char pchMessageStartMain[4] = { 0x29, 0x29, 0x65, 0x14 };
static unsigned char pchMessageStartTest[4] = { 0x14, 0x29, 0x29, 0x65 }; 

unsigned char pchMessageStart[4] = { 0x29, 0x29, 0x65, 0x14 };
